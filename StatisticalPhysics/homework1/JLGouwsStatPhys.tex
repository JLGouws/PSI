  ...
  \item
    ...
    \begin{enumerate}
      ...
      \item
        ...
        And  this gives:
        \begin{equation*}
          \kappa_T \sim \frac{b e^2}{2 k_B} (T - T_c)^{-1}
        \end{equation*}
        Which makes it clear that $\gamma = 1$.  
      \item
        The beta exponent is calculated in the same way as in the tutorial:
        \begin{figure}[H]
          \begin{center}
        ...
        Here:
        \begin{equation*}
          t \sim - \frac{x^2}{3} \Rightarrow x \sim \sqrt{-3 t}, \quad \text{as } t \to 0^-
        \end{equation*}
        or:
        \begin{equation*}
          v_l - 1 \sim - x\sim -\sqrt{3}|t|^{1/2} \quad \text{as } t \to 0^-
        \end{equation*}
        and:
        \begin{equation*}
          v_g - 1 \sim y \sim \sqrt{3}|t|^{1/2} \quad \text{as } t \to 0^-
        \end{equation*}
        Thus $\beta$ for this model is $1/2$.
